...
class ProjectJPRRepository private constructor(private val remoteDataSource: RemoteDataSource) :
    ProjectJPRDataSource {

    companion object {
        @Volatile
        private var instance: ProjectJPRRepository? = null
        fun getInstance(remoteData: RemoteDataSource): ProjectJPRRepository =
            instance ?: synchronized(this) {
                instance ?: ProjectJPRRepository(remoteData)
            }
    }
